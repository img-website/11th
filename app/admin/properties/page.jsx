                ...
                <div className='max-w-7xl mx-auto w-full px-4 relative py-10'>
                    <div className='flex '>
                        <div className='w-7/12 pe-4'>
                            <div className='text-black font-bold text-4xl dark:texx1t-white'> Add property</div>
                            <div className='bg-white shadow-md rounded-md dark:bg-slate-900 p-6 mb-8'>
                                ...
                                <form >
                                    <div>
                                        <div key="underlined" className="flex w-full flex-wrap md:flex-nowrap flex-col mb-6 md:mb-0 gap-4">
