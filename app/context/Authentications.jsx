...
export const AuthProvider = ({ children }) => {
    ...
    return (
        <AuthContext.Provider value={{ signupUserWithEmailAndPassword, signinUserWithEmailAndPass, signinWithGoogle, signOutHandle, isLoggedIn, user, mainLoading, setMainLoading }}>
            {children}
