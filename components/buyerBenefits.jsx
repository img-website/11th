    ...
    return (
        <div className="max-w-7xl mx-auto w-full relative py-16 px-4">
            <div className="grid grid-cols-1 pb-8 text-center">
                <h3 className="mb-4 md:text-3xl md:leading-normal text-2xl leading-normal font-semibold">Buyer Benefits</h3>
            ...
            <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 mt-8 gap-[30px]">
                <div className="group relative lg:px-10 transition-all duration-500 ease-in-out rounded-xl bg-transparent overflow-hidden text-center">
                    ...
                    <div className="mt-6">
                        <h5 className="text-xl font-medium">Free Consultation</h5>
                ...
                <div className="group relative lg:px-10 transition-all duration-500 ease-in-out rounded-xl bg-transparent overflow-hidden text-center">
                    ...
                    <div className="mt-6">
                        <h5 className="text-xl font-medium">Buyer Rebate Programs</h5>
                        <p className="text-slate-400 mt-3">If the distribution of letters and &apos;words&apos; is random, the reader will not be distracted from making.</p>
                    </div>
                </div>
                <div className="group relative lg:px-10 transition-all duration-500 ease-in-out rounded-xl bg-transparent overflow-hidden text-center">
                    ...
                    <div className="mt-6">
                        <h5 className="text-xl font-medium">Save Money</h5>
                        <p className="text-slate-400 mt-3">If the distribution of letters and &apos;words&apos; is random, the reader will not be distracted from making.</p>
                    </div>
                </div>
            </div>
