...
import { BathIcon, BedIcon, SqfIcon, EyeFilledIcon, SupportIcon, EditIcon, BackIcon } from '@/components/icons'
import Fancybox from '@/components/Fancybox'
import Link from "next/link";

export default function PropertyDetailModal({ isOpen, onOpenChange, selectedProperty }) {
    return (
                ...
                <ModalContent>
                    {(onClose) => (
                        <>
                            ...
                            <ModalFooter>
                                <Button color="danger" variant="flat" onPress={onClose} startContent={<BackIcon className="size-5" />}>
                                    Close
                                </Button>
                                <Button color="primary" variant="solid" startContent={<EditIcon className="size-5" />}>
                                    Edit
                                </Button>
                            </ModalFooter>
                        </>
